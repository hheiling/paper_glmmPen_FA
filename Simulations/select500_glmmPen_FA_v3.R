...
sub_folder = "select500_glmmPen_FA_v3/"
...
lam0_seq = LambdaSeq(X = X, y = y, family = "binomial", alpha = 1, 
                    lambda.min = seq_min_fixef, nlambda = 10,
                    penalty.factor = NULL)
lam1_seq = LambdaSeq(X = X, y = y, family = "binomial", alpha = 1, 
                     lambda.min = seq_min_ranef, nlambda = 10,
                     penalty.factor = NULL)
