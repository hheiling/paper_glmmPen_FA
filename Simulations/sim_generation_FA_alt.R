# Simulation of data for glmmPen_FA method
...
library(ncvreg)
library(stats)
sim.data.FA.alt = function(n, ptot, pnonzero, nstudies, sd_raneff = 0, 
                       family = "binomial", B = NULL, r = 2,
                       corr = NULL, seed, imbalance = 0, beta = NULL, 
                       pnonzerovar = 0, pzerovar = 0, sd_x = 1){
