...
# Arrays 1-1500 - 15 simulation types, 100 replicates per simulation type
...
sub_folder = "select100_glmmPen_FA_EN/" # EN = elastic net
...
r_val = c(3) 
# type of correlation
cor_type = c(0.2, 0.4, 0.6)
# value of alpha to consider
alpha_val = c(0.1, 0.3, 0.5, 0.8, 1.0)
# All simulation combinations
combos = expand.grid(est_type, B_size, beta_val, r_val, alpha_val, cor_type)
colnames(combos) = c("type", "B_size", "beta_val", "r_val", "alpha_val", "cor_type")
combos
