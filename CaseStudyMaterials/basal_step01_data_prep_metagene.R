...
path_data = "~/paper_glmmPen_FA/CaseStudyData"
# Specify path to location of any additional supporting information
path_suppInfo = "~/paper_glmmPen_FA/CaseStudyMaterials"
# Specify path to location of 'SubtypingDemo' repo content
path_SubtypingDemo = "~/paper_glmmPen_FA/SubtypingDemo_condensed"
# Save step01 results
path_save_results = "~/paper_glmmPen_FA/CaseStudyMaterialsReplicated"
