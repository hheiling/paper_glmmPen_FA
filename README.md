...
* load(file = "PDAC_basal.RData") may need to be updated for the location where the PDAC_basal.RData dataset is stored 

The code can be submitted to the computing cluster using commands as outlined below:
